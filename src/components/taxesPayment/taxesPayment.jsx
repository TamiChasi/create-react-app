        ...
        <>
          ...
          {taxesAmount === paidTaxesAmount ? (
            <div className='taxesPayment'>
              ...
              <Stack>
                <Button className='btnStyle' component={Link} variant="contained" margin={'5px'} onClick={redirectToTaxesPayment}>{t("paymentConfirmation")}</Button>
                <Link
                  href="https://www.gov.il/he/pages/payments"
                  target="_blank"
